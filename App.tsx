        ...
        <aside className="w-64 border-r border-slate-800 bg-slate-900/50 flex flex-col shrink-0">
          ...
          <div className="p-4 border-t border-slate-800">
            <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700/50">
              ...
              <div className="mt-2 text-[10px] text-slate-500">Stability: Continuous</div>
            </div>
          </div>
        </aside>
        ...
        <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
          <header className="h-16 border-b border-slate-800 flex items-center justify-between px-8 bg-slate-900/20 backdrop-blur-md z-10 shrink-0">
            <div className="flex items-center gap-4 flex-1">
              <div className="relative max-w-md w-full">
                ...
                <input 
                  type="text" 
                  placeholder="Search logs, IPs, or threat patterns..." 
            ...
            <div className="flex items-center gap-4">
              ...
              >
                ...
                {isLive ? 'Monitoring' : 'System Paused'}
              </button>
          ...
          <div className="flex-1 overflow-y-auto p-8 scroll-smooth">
            <Routes>
              ...
              <Route path="/traffic" element={<TrafficMonitor logs={logs} />} />
